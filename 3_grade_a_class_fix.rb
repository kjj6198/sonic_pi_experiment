...
ending2 = ring :a5, :c6, :d6, :a6, :g6, :a6
...
live_loop :open do
  ...
  with_fx :reverb do
    16.times do
      use_synth :piano
      play_chord opening.look(:next), release: 1.5, amp: fadein.look if spread(5, 16).tick
      use_synth :saw
      play opening2.look(:next), release: 0.25, amp: range(0.4, 1.5, step: 0.2).look if spread(5, 16).look
      sleep 0.125
    end
  end
end
